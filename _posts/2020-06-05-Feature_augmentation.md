...
# <font face="黑体" color=green size=5>一、特征衍生</font>
...
![img](file:///C:\Users\db129\AppData\Local\Temp\ksohtml11476\wps1.jpg) 

​				一开始，一组未经选择和进化的原始因子会被随机生成(第一代因子)，通过某种规则计算每个因子的适应度，从中选出适合的个体作为下一代进化的父代。 这些被选择出来的父代通过多种方法进化，形成不同的后代因子，然后循环进行下一轮进化。随着迭代次数的增长，因子不断繁殖、变异、进化，从而不断逼近数据分布的真相。 
...
![img](file:///C:\Users\db129\AppData\Local\Temp\ksohtml11476\wps2.png) 



​		第一个SUM（∑）里面是一个线性回归求损失平方，第二个SUM（∑）是线性回归中系数的服从条件，用来约束解的区域。此外，Lasso 回归的整体损失求极小的样子改成拉格朗日形式，公式2：

![img](file:///C:\Users\db129\AppData\Local\Temp\ksohtml11476\wps3.png) 
...
![img](file:///C:\Users\db129\AppData\Local\Temp\ksohtml11476\wps4.png) 
...
![img](file:///C:\Users\db129\AppData\Local\Temp\ksohtml11476\wps5.jpg) 
